...
$Qreturn = "UPDATE hotspot SET id1=?, id2=?, pitch=?, yaw=?, weight=? WHERE id1=? AND id2=?";
$stmtQreturn= $conn->prepare($Qreturn);
$stmtQreturn->execute([$_GET['id2'], $_GET['id1'], $_GET['pitch'], $_GET['yaw'], $_GET['weight'], $_GET['actuaNextHotSpot'],$_GET['id1']]);
